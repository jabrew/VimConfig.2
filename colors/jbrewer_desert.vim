...
" source ~/.vim/bundle/tomorrow-theme-vim/colors/Tomorrow-Night-Eighties.vim
...
" Taken from Tomorrow-Night-Eighties {
...
" Desert from /usr/local/Cellar/macvim/7.4-98/MacVim.app/Contents/Resources/vim/vimfiles {
...
"                           VISIBLE and is the active buffer
" hi link MBNormal Comment
" hi MBEChanged guifb=

" hi link MBEVisibleChanged Error
" hi MBEChanged guibg=darkblue ctermbg=darkblue termbg=white

" Colors from https://en.wikipedia.org/wiki/X11_color_names
hi link MBENormal                Comment

hi link MBEVisibleActiveNormal   Underlined

hi MBEChanged                    guifg=#FFDAB9
hi MBEVisibleActiveChanged       guifg=#F9A68A term=underline gui=underline
hi MBEVisibleChanged             guifg=#E9967A

hi link MBEVisibleActiveChanged  String
hi      MBEVisibleNormal         guifg=#DFBE8D
